...
the Satellite provided URL on that screen.  To execute this script
against every ImageStream in one batch run, do this:
`OC_EDITOR=./fix.sh oc edit is -n openshift`.
